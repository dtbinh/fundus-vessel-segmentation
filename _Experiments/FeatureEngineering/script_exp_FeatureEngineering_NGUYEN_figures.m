...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Nguyen\nguyen_ARIA\aria_armd_05_test_nguyen_');
% windowSize = 47;
% padsize = 50;
% options.w = 27;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Nguyen\nguyen_ARIA\aria_diabetic_(0001)aria_d_26_nguyen_');
% windowSize = 47;
% padsize = 50;
% options.w = 27;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Nguyen\nguyen_ARIA\aria_normal_aria_c_1_7_nguyen_');
% windowSize = 47;
% padsize = 50;
% options.w = 27;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Nguyen\nguyen_CHASEDB\chase_Image_01L_nguyen_');
% windowSize = 89;
% padsize = 100;
% options.w = 43;
...
outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Nguyen\nguyen_DRIVE\drive_37_training_');
windowSize = 43;
padsize = 50;
options.w = 20;
...
feature_with_preprocessing = Nguyen2013(I - background, mask, false, options);
