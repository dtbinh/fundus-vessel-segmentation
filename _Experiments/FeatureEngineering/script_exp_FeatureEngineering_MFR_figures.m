...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_ARIA\aria_armd_05_test_mfr_');
% windowSize = 47;
% padsize = 50;
% options.sigmas = sqrt(1:2:11);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_ARIA\aria_diabetic_(0001)aria_d_26_mfr_');
% windowSize = 47;
% padsize = 50;
% options.sigmas = sqrt(1:2:11);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_ARIA\aria_normal_aria_c_1_7_mfr_');
% windowSize = 47;
% padsize = 50;
% options.sigmas = sqrt(1:2:11);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_CHASEDB\chase_Image_01L_mfr_');
% windowSize = 89;
% padsize = 100;
% options.sigmas = sqrt(1:7:22);
...
outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_DRIVE\drive_37_training_');
windowSize = 43;
padsize = 50;
options.sigmas = sqrt(1:2:3);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_HRF\hrf_dr_03_dr_');
% windowSize = 119;
% padsize = 100;
% options.sigmas = sqrt(36:10:66);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_HRF\hrf_glaucoma_04_g_');
% windowSize = 119;
% padsize = 100;
% options.sigmas = sqrt(36:10:66);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_HRF\hrf_healthy_04_h_');
% windowSize = 119;
% padsize = 100;
% options.sigmas = sqrt(36:10:66);
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\MatchedFilterResponses\mfr_STARE\stare_04_test_');
% windowSize = 43;
% padsize = 50;
% options.sigmas = sqrt(1:2:7);
...
f = MatchedFilterResponses(I, mask, false, options);
...
feature_with_preprocessing = MatchedFilterResponses(I - background, mask, false, options);
