...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_ARIA\aria_armd_05_test_soares_');
% windowSize = 47;
% padsize = 50;
% options.scales = 2:1:5;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_ARIA\aria_diabetic_(0001)aria_d_26_soares_');
% windowSize = 47;
% padsize = 50;
% options.scales = 2:1:5;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_ARIA\aria_normal_aria_c_1_7_soares_');
% windowSize = 47;
% padsize = 50;
% options.scales = 2:1:5;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_CHASEDB\chase_Image_01L_soares_');
% windowSize = 89;
% padsize = 100;
% options.scales = 2:1:8;
...
outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_DRIVE\drive_37_training_');
windowSize = 43;
padsize = 50;
options.scales = 1:1:3;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_HRF\hrf_dr_03_dr_');
% windowSize = 119;
% padsize = 100;
% options.scales = 6:1:10;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_HRF\hrf_glaucoma_04_g_');
% windowSize = 119;
% padsize = 100;
% options.scales = 6:1:10;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_HRF\hrf_healthy_04_h_');
% windowSize = 119;
% padsize = 100;
% options.scales = 6:1:8;
...
% outputPath = strcat(whereIsDropbox,'\Dropbox\RetinalImaging\Writing\tmi2015paper\experiments\featureEngineering\Soares\soares_STARE\stare_04_test_');
% windowSize = 43;
% padsize = 50;
% options.scales = 2:1:3;
...
f = Soares2006(I, mask, false, options);
...
feature_with_preprocessing = Soares2006(I - background, mask, false, options);
